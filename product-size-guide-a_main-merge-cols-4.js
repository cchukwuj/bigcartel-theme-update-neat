...
(function(){
  ...
  var subtitleEl = document.createElement('div'); subtitleEl.className = 'size-guide-modal-subtitle'; subtitleEl.innerText = 'all measurements are labeled in inches, measurements may vary slightly';
